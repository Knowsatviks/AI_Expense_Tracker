...
export const getSummary = async (req, res) => {
  try {
    ...
    const incomeThisMonth = row.income_this_month;
    const expenseThisMonth = row.expense_this_month;
    const incomeLastMonth = row.income_last_month;
    const expenseLastMonth = row.expense_last_month;
    ...
    res.status(500).json({ message: "Error getting transactional summary" });
  }
};
